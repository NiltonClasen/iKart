        ...
        if (!finishedSceneSetup)
        {
            ...
            */
            if (NetworkClient.Instance.IsHost)
            {
                ...
                guiManager.SetMainText("Host entrou na sala jogador entrou na sala");
                guiManager.SetMainText(NetworkClient.Instance.PlayerId);
            }
            else
            {
                NetworkClient.Instance.LastSpawner.SpawnForPlayer(0, 0);
                guiManager.SetMainText("Outro jogador entrou na sala");
                guiManager.SetMainText(NetworkClient.Instance.PlayerId);
            }
